                        ...
                        return html`
                            <div class="aa-ItemWrapper" data-url="${item.url}">
                                ...
                                <div class="aa-ItemActions">
                                    <span style="font-size: 0.9em;margin-right: 8px" class="text-success">${item.categories}</span>
                                </div>
                            </div>`;
                    },
                },
                    ...
                    item({item, html}) {
                        return html`
                            <div class="aa-ItemWrapper" data-url="${item.url}">
                                ...
                                <div class="aa-ItemActions">
                                    <span style="font-size: 0.9em; margin-right: 8px" class="text-success">${item.price}</span>
                                </div>
                            </div>`;
                    },
                }
